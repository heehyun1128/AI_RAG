...
const Hero: React.FC = () => {
  return (
    <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-16 text-center relative z-10 text-default">
      ...
      >
        Revolutionize your course selection with AI-powered professor ratings. Comprehensive,
        {' '}
      ...
      >
        Harnessing advanced AI to generate comprehensive professor evaluations from student feedback,
        optimizing your course selection process.
      </motion.p>
    </main>
  );
};
